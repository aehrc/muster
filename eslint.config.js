...
export default tseslint.config(
...

  {
    ...
    rules: {
      ...
      // Muster signs statements and tickets and reaches participant-supplied
      // addresses: an unawaited promise here is a security bug, not a style nit.
      "@typescript-eslint/no-floating-promises": "error",
      "@typescript-eslint/no-misused-promises": "error",
      // A `default` clause is a legitimate way to be exhaustive.
      ...
      // Domain vocabulary here is FHIR/OAuth abbreviations (jwks, iss, aud, dcr).
  ...
  // React components are the one exception to the lowerCamelCase filename rule.
  {
    files: ["apps/web/**/*.tsx"],
    rules: {
  ...
  // and by package scripts, outside any package's tsconfig, so type-aware rules
